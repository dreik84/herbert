...
class VarArgs3 {
	...
	static void vaTest(int ... v) {  // Первая версия vaTest()
	...
	static void vaTest(boolean ... v) {  // Вторая версия vaTest()
	...
	static void vaTest(String msg, int ... v) {  // Третья версия vaTest()
