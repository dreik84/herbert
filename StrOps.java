...
class StrOps {
	public static void main(String[] args) {
		...
		if (str1.equals(str2)) System.out.println("str1 равна str2");
		else System.out.println("str1 не равна str2");

		if (str1.equals(str3)) System.out.println("str1 равна str3");
                else System.out.println("str1 не равна str3");
